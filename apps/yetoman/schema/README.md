...
- to create: `yarn prisma:yetoman:migration:create
- to apply: `yarn prisma:yetoman:migration:apply
...
- to create/update: `yarn prisma:yetoman:generate`
...
- to create/update: `yarn serve yetoman`
